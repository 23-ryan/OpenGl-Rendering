// Making two triangles side by side using two different VAOs  and using two different shaders.
...
// setting the value of teh vec4 variable to send to fragment shader to use
...
// uniforms can be used from anywhere in the shader program, either vertex or fragment shader.
// DO use uniform variable if yoyu have defined that in your program, other wise frustrating errors.
"uniform vec4 ourColor;\n"  // setting the value of color using uniforms
...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// We need to run the shader program to set the value of the uniform variable becoz, 
		// it sets the uniform om the currently active shader program.
